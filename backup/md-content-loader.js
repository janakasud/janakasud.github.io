/**
 * Markdown Content Loader with In-Page TOC Generator
 * 
 * This script:
 * 1. Fetches a markdown file
 * 2. Renders it to HTML using marked.js
 * 3. Generates a table of contents from headings
 * 4. Typesets MathJax equations if present
 */
